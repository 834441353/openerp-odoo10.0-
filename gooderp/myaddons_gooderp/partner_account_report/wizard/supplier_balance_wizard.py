...
class ReportSupplierBalanceWizard(models.TransientModel):
    _name = 'report.supplier.balance.wizard'
    _description = u'应付账款汇总表向导'
    ...
    def open_report(self):
        return {
            ...
            'res_model': 'report.supplier.balance',
            'view_mode': 'tree',
            'name': u'应付账款汇总表 %s 至  %s ' % (self.date_start, self.date_end),
