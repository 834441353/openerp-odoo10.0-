...
class ReportCustomerBalanceWizard(models.TransientModel):
    _name = 'report.customer.balance.wizard'
    _description = u'应收账款汇总表向导'
    ...
    def open_report(self):
        return {
            ...
            'res_model': 'report.customer.balance',
            'view_mode': 'tree',
            'name': u'应收账款汇总表 %s 至  %s ' % (self.date_start, self.date_end),
            'context': self.read(['date_start', 'date_end', 'partner_id',])[0],
            'limit': 65535,
        }
